...
public class AgreementSignDates {
	...
	public static HashMap<Long, HashMap<Long, Integer>> getUserAgreementStatus() throws IOException, SQLException {
	...
	public static HashMap<Long, Integer> getAgreementStatusForUser_id(String user_id) throws IOException, SQLException {
	...
	public static Integer getAgreementStatusForUser_id(String user_id, String agreement_id) throws IOException, SQLException {
