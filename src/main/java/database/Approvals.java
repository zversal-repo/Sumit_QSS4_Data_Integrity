...
public class Approvals {
	...
	public static HashMap<Long, HashMap<Long,HashMap<Long, Boolean>>> getApprovalStatus() throws IOException, SQLException {
		...
		return QueryProcessor.getMap(query, "user_id","product_id", "agreement_id", "status", 1L,1L, 1L, true);
	}
